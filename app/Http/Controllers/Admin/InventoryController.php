...
class InventoryController extends Controller
{
    ...
    public function index(IndexInventory $request)
    {
        ...
        $data = AdminListing::create(Inventory::class)
            ->processRequestAndGet(
            // pass the request with params
            $request,

            // set columns to query
            ['inventory.id', 'products.product_name', 'sku', 'quantity', 'color', 'size', 'price_cents', 'cost_cents'],

            // set columns to searchIn
            ['products.product_name', 'color', 'inventory.id', 'note', 'size', 'sku'],

            function ($query) {
                $query->with(['product']);
                $query->join('products', 'products.id', '=', 'inventory.product_id');
    ...
    public function store(StoreInventory $request)
    {
        ...
        $sanitized['product_id'] = $sanitized['product_name']['id'];
